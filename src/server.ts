...
const TEST = [{area: 'Entrance', entity_id: 'light.backdoor_lamp', type: 'light', friendly_name: 'Backdoor lamp', integration: 'homeassistant', supported_features: []}, {area: 'Entrance', entity_id: 'light.entrance_lamp_level', type: 'light', friendly_name: 'Entrance lamp', integration: 'homeassistant', supported_features: ['BRIGHTNESS']}, {area: 'Kitchen', entity_id: 'light.kitchen_dimmer_level', type: 'light', friendly_name: 'Kitchen lamp', integration: 'homeassistant', supported_features: ['BRIGHTNESS']}, {area: 'Kitchen', entity_id: 'light.kitchen_table_lamp_level', type: 'light', friendly_name: 'Kitchen table lamp', integration: 'homeassistant', supported_features: ['BRIGHTNESS']}, {area: 'Kitchen', entity_id: 'light.kitchen_sink_lamp', type: 'light', friendly_name: 'Kitchen sink lamp', integration: 'homeassistant', supported_features: []}, {area: 'Kitchen', entity_id: 'light.kitchen_floor', type: 'light', friendly_name: 'Kitchen floor lamp', integration: 'homeassistant', supported_features: ['BRIGHTNESS', 'COLOR']}, {area: 'Living room', entity_id: 'light.living_room_lamp_level', type: 'light', friendly_name: 'Living room lamp', integration: 'homeassistant', supported_features: ['BRIGHTNESS']}, {area: 'Living room', entity_id: 'light.living_room_corner_lamp_level', type: 'light', friendly_name: 'Living room corner lamp', integration: 'homeassistant', supported_features: ['BRIGHTNESS', 'COLOR']}, {area: 'Living room', entity_id: 'light.desk_lamp', type: 'light', friendly_name: 'Desk lamp', integration: 'homeassistant', supported_features: ['BRIGHTNESS', 'COLOR']}, {area: 'Bedroom', entity_id: 'light.bedroom_lamp_level', type: 'light', friendly_name: 'Bedroom lamp', integration: 'homeassistant', supported_features: ['BRIGHTNESS']}, {area: 'Bedroom', entity_id: 'light.dalma_night_stand', type: 'light', friendly_name: 'Dalma night stand lamp', integration: 'homeassistant', supported_features: ['BRIGHTNESS', 'COLOR']}, {area: 'Bedroom', entity_id: 'light.marci_night_stand', type: 'light', friendly_name: 'Marci night stand lamp', integration: 'homeassistant', supported_features: ['BRIGHTNESS', 'COLOR']}, {area: 'Bathroom', entity_id: 'light.bathroom_switch_level', type: 'light', friendly_name: 'Bathroom lamp', integration: 'homeassistant', supported_features: ['BRIGHTNESS']}, {area: 'Living room', entity_id: 'media_player.beoplay_m5', type: 'media_player', friendly_name: 'BeoPlay M5', integration: 'homeassistant', supported_features: ['SOURCE', 'APP_NAME', 'VOLUME', 'VOLUME_UP', 'VOLUME_DOWN', 'VOLUME_SET', 'MUTE', 'MUTE_SET', 'MEDIA_TYPE', 'MEDIA_TITLE', 'MEDIA_ARTIST', 'MEDIA_ALBUM', 'MEDIA_DURATION', 'MEDIA_POSITION', 'MEDIA_IMAGE', 'PLAY', 'PAUSE', 'STOP', 'PREVIOUS', 'NEXT', 'SEEK', 'SHUFFLE', 'TURN_ON', 'TURN_OFF']}, {area: 'Living room', entity_id: 'media_player.beoplay_s8', type: 'media_player', friendly_name: 'BeoPlay S8', integration: 'homeassistant', supported_features: ['SOURCE', 'APP_NAME', 'VOLUME', 'VOLUME_UP', 'VOLUME_DOWN', 'VOLUME_SET', 'MUTE', 'MUTE_SET', 'MEDIA_TYPE', 'MEDIA_TITLE', 'MEDIA_ARTIST', 'MEDIA_ALBUM', 'MEDIA_DURATION', 'MEDIA_POSITION', 'MEDIA_IMAGE', 'PLAY', 'PAUSE', 'STOP', 'PREVIOUS', 'NEXT', 'SEEK', 'SHUFFLE', 'TURN_ON', 'TURN_OFF']}, {area: 'Kitchen', entity_id: 'media_player.kitchen', type: 'media_player', friendly_name: 'Kitchen speaker', integration: 'homeassistant', supported_features: ['SOURCE', 'APP_NAME', 'VOLUME', 'VOLUME_UP', 'VOLUME_DOWN', 'VOLUME_SET', 'MUTE', 'MUTE_SET', 'MEDIA_TYPE', 'MEDIA_TITLE', 'MEDIA_ARTIST', 'MEDIA_ALBUM', 'MEDIA_DURATION', 'MEDIA_POSITION', 'MEDIA_IMAGE', 'PLAY', 'PAUSE', 'STOP', 'PREVIOUS', 'NEXT', 'SEEK', 'SHUFFLE', 'TURN_ON', 'TURN_OFF']}, {area: 'Living room', entity_id: 'media_player.dm_tv', type: 'media_player', friendly_name: 'Apple TV', integration: 'homeassistant', supported_features: ['SOURCE', 'APP_NAME', 'VOLUME', 'VOLUME_UP', 'VOLUME_DOWN', 'VOLUME_SET', 'MUTE', 'MUTE_SET', 'MEDIA_TYPE', 'MEDIA_TITLE', 'MEDIA_ARTIST', 'MEDIA_ALBUM', 'MEDIA_DURATION', 'MEDIA_POSITION', 'MEDIA_IMAGE', 'PLAY', 'PAUSE', 'STOP', 'PREVIOUS', 'NEXT', 'SEEK', 'SHUFFLE', 'TURN_ON', 'TURN_OFF']}, {area: 'Living room', entity_id: 'spotify.spotify', type: 'media_player', friendly_name: 'Spotify', integration: 'spotify', supported_features: ['SOURCE', 'APP_NAME', 'VOLUME', 'VOLUME_UP', 'VOLUME_DOWN', 'VOLUME_SET', 'MUTE', 'MUTE_SET', 'MEDIA_TYPE', 'MEDIA_TITLE', 'MEDIA_ARTIST', 'MEDIA_ALBUM', 'MEDIA_DURATION', 'MEDIA_POSITION', 'MEDIA_IMAGE', 'PLAY', 'PAUSE', 'STOP', 'PREVIOUS', 'NEXT', 'SEEK', 'SHUFFLE', 'SEARCH', 'SPEAKER_CONTROL', 'LIST']}, {area: 'Living room', entity_id: 'remote.living_room', type: 'remote', friendly_name: 'Living room TV', integration: '', supported_features: ['POWER_TOGGLE', 'CHANNEL_UP']}];
